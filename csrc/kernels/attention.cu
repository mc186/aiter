    ...
    int64_t partition_size)
{
    ...
    args.k_scale_ptr = reinterpret_cast<const float*>(k_scale.data_ptr());
    args.v_scale_ptr = reinterpret_cast<const float*>(v_scale.data_ptr());
