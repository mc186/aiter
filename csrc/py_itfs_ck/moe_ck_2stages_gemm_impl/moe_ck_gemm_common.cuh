...
)
{
    ...
    static constexpr ck::index_t NPerBlock =
        PipelineVer == ck::BlockGemmPipelineVersion::v1 ? 64 : 128;
    // MPerBlock == 64 ? 64 : 128;
...
#define CK_MOE_STAGE1_GEMM_DEFINE(                                              \
    MPerfBlock, KPerBlock, MWaves, NWaves, PipelineVer, MulRoutedWeight, ActOP) \
