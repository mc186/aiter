...
//     int ActOP
//     >
// void ck_moe_stage1_gemm_mxfp4(const hipStream_t &stream, int tokens, int sorted_size, int N, int
// K,
//                         int topk,
//                         void *&hidden_states,           // [m, k], input token
//                         void *&w1,                      // [e, n, k]/[e, 2*n, k], pre-shuffle([e,
//                         nr, kr, w]) void *&w2,                      // [expert, dim, inter_dim],
//                         pre-shuffle([e, nr, kr, w]) void *&sorted_token_ids,        //
//                         [max_num_tokens_padded] void *&sorted_expert_ids,       //
//                         [max_num_m_blocks] void *&sorted_weights, void *&num_valid_ids, //[1]
...
//     static constexpr ck::index_t NPerBlock = MPerBlock == 32 ? 128 : 64; //PipelineVer ==
//     ck::BlockGemmPipelineVersion::v1 ? 128 : 256; static constexpr ck::index_t WAVES = BLOCKSIZE
//     / 64;
...
//     // static constexpr ck::index_t KPerBlock = ck::is_same_v<B0DataType, I4> ? 128 : 256 /
//     sizeof(A0DataType); static constexpr ck::index_t AK1 = 16 / sizeof(A0DataType); static
//     constexpr ck::index_t BK1 = 32 / sizeof(B0DataType); static constexpr ck::index_t EVec = 16 /
//     sizeof(EDataType); static constexpr ck::index_t K0_A = KPerBlock / AK1; static constexpr
//     ck::index_t K0_B = KPerBlock / BK1; static constexpr ck::index_t K0_M_A = BLOCKSIZE / K0_A;
...
//     ck::tensor_operation::device::DeviceMoeGemmMXBNS<
//         A0Layout,    B0Layout,    DsLayout,    ELayout,
//         A0DataType,  A1DataType,  B0DataType,  B1DataType,  DsDataType, EDataType, AccDataType,
//         CShuffleDataType, AElementOp,  BElementOp, CDEElementOp, GemmSpec, ScaleBlockSize, 256,
...
//         ck::BlockGemmPipelineScheduler::Intrawave, ck::BlockGemmPipelineVersion::v3, ActOP,
//         Nswizzle, true, MulRoutedWeight, ck::index_t, A0DataType>;// clang-format on
...
//     bool MulRoutedWeight
// >
// void ck_moe_stage2_gemm_mxfp4(const hipStream_t &stream, int tokens, int sorted_size, int N, int
// K,
//                         int topk,
//                         void *&inter_states,            // [max_num_tokens_padded, k], input
//                         token void *&w1,                      // [e, n, k]/[e, 2*n, k],
//                         pre-shuffle([e, nr, kr, w]) void *&w2,                      // [expert,
//                         dim, inter_dim], pre-shuffle([e, nr, kr, w]) void *&sorted_token_ids, //
//                         [max_num_tokens_padded] void *&sorted_expert_ids,       //
//                         [max_num_m_blocks] void *&sorted_weights,          //
//                         [max_num_tokens_padded] void *&num_valid_ids,           //[1] void *&out,
//                         // [m, out_dim] std::optional<void *> w2_scale, // [e, 1, n], gate(up)
//                         scale std::optional<void *> a2_scale  // [max_num_tokens_padded, 1],
//                         token scale
// )
// {
//     // ~~~~~~~~~~~~~~~~~~~~~~~~following start with ck things
...
//     static constexpr ck::index_t NXDLPerWave = NPerBlock / (MNPerXDL * NWaves);
//     // static constexpr ck::index_t KPerBlock = ck::is_same_v<B0DataType, I4> ? 128 : 256 /
//     sizeof(A0DataType); static constexpr ck::index_t CShuffleMXDLPerWave =
//     ck::is_same_v<B0DataType, I4> ? 2 : MXDLPerWave; static constexpr ck::index_t
//     CShuffleNXDLPerWave = ck::is_same_v<B0DataType, I4> ? 2 : NXDLPerWave; static constexpr
//     ck::index_t CShuffleNLane = ck::is_same_v<B0DataType, I4> ? 32 : NPerBlock / 2 / NXDLPerWave;
//     // 64 static constexpr ck::index_t CShuffleMLane = BLOCKSIZE / CShuffleNLane; static
//     constexpr ck::index_t AK1 = 16 / sizeof(A0DataType); static constexpr ck::index_t BK1 = 32 /
//     sizeof(B0DataType); static constexpr ck::index_t EVec = 2; static constexpr ck::index_t D0Vec
//     = 1; static constexpr ck::index_t D1Vec = PerTensorQuant ? 1 : EVec; static constexpr
//     ck::index_t D2Vec = 1; static constexpr ck::index_t K0_A = KPerBlock / AK1; static constexpr
//     ck::index_t K0_B = KPerBlock / BK1; static constexpr ck::index_t K0_M = BLOCKSIZE / K0_A;
...
//     ck::BlockGemmPipelineScheduler::Intrawave, ck::BlockGemmPipelineVersion::v3, 0, false, false,
//     MulRoutedWeight, ck::index_t, A0DataType>;
// // clang-format on
