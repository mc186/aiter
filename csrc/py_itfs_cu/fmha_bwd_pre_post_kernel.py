        ...
        std::optional<at::Generator> gen_)
{
    ...
    if (seqlen_q > 0) {
        ...
        auto traits =
            get_ck_fmha_bwd_traits_all(mask, q_dtype_str, head_size_q, head_size_v, is_dropout, alibi_slopes_.has_value(), deterministic, true, is_v3_atomic_fp32, how_v3_bf16_cvt);
