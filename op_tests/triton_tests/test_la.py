...
@pytest.mark.parametrize(
    ...
    [
        (False, 1, 64, 16, [65536], 128, 912, torch.float16, 16, 64, 2, 4),
        (False, 1, 64, 16, [131072], 128, 912, torch.float16, 16, 64, 2, 4),
        (False, 1, 64, 16, [262144], 64, 912, torch.float16, 16, 64, 2, 4),
        (False, 1, 64, 16, [524288], 64, 912, torch.float16, 16, 64, 2, 4),
        (False, 1, 96, 16, [32768], 128, 912, torch.float16, 16, 64, 2, 4),
        (False, 1, 96, 16, [65536], 128, 912, torch.float16, 16, 64, 2, 4),
        (False, 1, 96, 16, [131072], 128, 912, torch.float16, 16, 64, 2, 4),
        ...
        (False, 1, 128, 16, [32768], 128, 912, torch.float16, 16, 64, 2, 4),
        (False, 1, 128, 16, [65536], 128, 912, torch.float16, 16, 64, 2, 4),
        (False, 1, 128, 16, [131072], 128, 912, torch.float16, 16, 64, 2, 4),
        (False, 1, 128, 16, [262144], 64, 912, torch.float16, 16, 64, 2, 4),
        (False, 1, 128, 16, [524288], 16, 912, torch.float16, 16, 256, 1, 4),  #
        (False, 3, 64, 16, [4096, 32768, 65536], 128, 912, torch.float16, 16, 64, 2, 4),
        (
            False,
            8,
            64,
